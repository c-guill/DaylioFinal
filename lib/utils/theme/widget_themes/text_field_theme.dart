...
class TTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle().copyWith(fontSize: TSizes.fontSizeMd, color: TColors.black.withOpacity(0.4)),
    hintStyle: const TextStyle().copyWith(fontSize: TSizes.fontSizeSm, color: TColors.black.withOpacity(0.4)),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    suffixIconColor: TColors.darkGrey,
    constraints: const BoxConstraints.expand(height: TSizes.inputFieldHeight),
    labelStyle: const TextStyle().copyWith(fontSize: TSizes.fontSizeMd, color: TColors.white.withOpacity(0.4)),
    hintStyle: const TextStyle().copyWith(fontSize: TSizes.fontSizeSm, color: TColors.white.withOpacity(0.4)),
