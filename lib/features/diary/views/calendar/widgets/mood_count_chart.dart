    ...
    return Obx(() => ContainerCustom(
      ...
      child: Column(
        children: [
          ...
          Text(
            'Mood Count',
            style: Theme.of(context).textTheme.headlineMedium!.copyWith(color: TColors.textPrimary),
          ),
              ...
              listData: List.generate(controller.ranking.length, (index) {
                return DChartBarDataCustom(
                  ...
                  labelCustom: controller.ranking[index]['class'] == 'rad'
                      ...
                      angle: 0.0,
                      child: const Image(
                          image: AssetImage('assets/icons/emotions/rad.png'), width: TSizes.iconMd, height: TSizes.iconMd))
                      : controller.ranking[index]['class'] == 'good'
                      ? Transform.rotate(
                      angle: 0,
                      child: const Image(
                          image: AssetImage('assets/icons/emotions/good.png'), width: TSizes.iconMd, height: TSizes.iconMd))
                      : controller.ranking[index]['class'] == 'meh'
                      ? Transform.rotate(
                      angle: 0,
                      child: const Image(
                          image: AssetImage('assets/icons/emotions/meh.png'), width: TSizes.iconMd, height: TSizes.iconMd))
                      : controller.ranking[index]['class'] == 'sad'
                      ? Transform.rotate(
                      angle: 0,
                      child: const Image(
                          image: AssetImage('assets/icons/emotions/sad.png'), width: TSizes.iconMd, height: TSizes.iconMd))
                      : controller.ranking[index]['class'] == 'awful'
                      ? Transform.rotate(
                      angle: 0,
                      child: const Image(
                          image: AssetImage('assets/icons/emotions/awful.png'), width: TSizes.iconMd, height: TSizes.iconMd))
                      : null,
                );
              }),
            ),
